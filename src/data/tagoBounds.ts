...
export const TAGO_CENTER: [number, number] = [8.97, 126.17];

// Bounds covering all 23 barangays of Tago — extended south to include
...
[9.05, 126.27] // Northeast corner — covers Victoria/Purisima/Jubang
];
...
{ name: 'Anahao Bag-o', lat: 8.963, lng: 126.1608 },
